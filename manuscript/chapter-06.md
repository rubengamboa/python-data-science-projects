...
A> Notice that these probabilities do not need to add up to 100%, since they make different assumptions, i.e., they assume different cities for the starting condition.
